...
function Index(props) {
  ...
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Looking for the best chiropractors near you? You're at the right place! We have selected the best chiropractors from all over the globe to help you live life to the fullest. Find a chiropractor today!" />
        ...
        <Paper className={classes.contentwrapper}>
          <Grid container>
            ...
            <Grid item xs={12} sm={8}>
              ...
              <p align="justify" className={classes.bodytext2}>
            ...
            <Grid item xs={12}>
              <div className={classes.title}>
                ...
                <li>
                  <a href="/chiropractor-liverpool" style={{textDecoration: 'None', color: '#000',}}>Liverpool Chiropractor</a>
                </li>
                <br />
                <br />
              </div>
